...
import { getDataIndo } from '../utils/ApiService';
      ...
      <>
        <View
          ...
          <View style={styles.cardPositif}>
            ...
            <View style={{ marginVertical: 5 }}>
              <Text style={styles.number}>{this.state.data.jumlahKasus}</Text>
            </View>
          </View>
          <View style={styles.cardDeath}>
            <Text style={styles.title}> MENINGGAL </Text>
            <View style={{ marginVertical: 5 }}>
              <Text style={styles.number}>{this.state.data.meninggal}</Text>
            </View>
          </View>
        </View>
        ...
        <View
          ...
          <View style={styles.cardRawat}>
            ...
            <View style={{ marginVertical: 5 }}>
              <Text style={styles.number}>{this.state.data.perawatan}</Text>
            </View>
          </View>
          <View style={styles.cardSembuh}>
            <Text style={styles.title}> SEMBUH </Text>
            <View style={{ marginVertical: 5 }}>
              <Text style={styles.number}>{this.state.data.sembuh}</Text>
            </View>
          </View>
        </View>
      </>
